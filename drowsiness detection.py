"""
CSE 563: Software Requirements and Specifications Project

Drowsiness Detection and Alert System
-------------------------------------
System designed to detect if the driver is dorwsy
or not depending on the Eye Aspect Ratio (EAR).
If EAR goes below certain threshold value, the system
will detect it as drowsy driver and alert the driver
by playing alarm tone.
